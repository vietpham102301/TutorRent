...
<main id="main" class="main">
	...
	<!-- End Page Title -->
	 <a href = "/CNPM/QuanLy/Post/PostNotApply.html"><button type="button"
		class="btn add-new btn-outline-danger shadow-none">Bài đăng chưa được apply
		 <i class="bi bi-plus-circle"></i></button></a>
	<a href = "/CNPM/QuanLy/Post/PostApply.html"><button type="button"
						...
						<tbody>
							<c:forEach var = "u" items = "${lists}">
								<tr>
									...
									<td><span><a href = "/CNPM/QuanLy/Post/PostApply/${u.postId}.html?info"> <i
