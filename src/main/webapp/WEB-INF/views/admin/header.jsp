...
<%-- 		<img src="<c:url value="//resources//image//${userPhotoName}" />" class="rounded-circle" width="150"/> --%>
		<img src="<c:url value="/resources/image/logo.png"/>" alt="" /> <span
			class="d-none d-lg-block">Quản lý</span>
...
<%-- 					src="<c:url value='/resources/image/profile-img.jpg'/>" alt="Profile" --%>
				...
				<ul
					...
					<li class="dropdown-header">
						<h6>Phạm Hoàng Việt</h6> <span>Quản trị</span>
					</li>
					<li>
...
<!-- 					</a></li> -->
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="tutor/login.html"> <i class="bi bi-box-arrow-right"></i>
							<span>Đăng xuất</span>
					</a></li>
